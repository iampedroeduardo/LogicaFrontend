    ...
    return (
        <View style={styles.container}>
            <Appbar.Header style={styles.header}>
                <Logo ImagemEstilo={{width: 40, height: 32,}} textoEstilo={{fontSize: 22, color: 'white'}}/>
                <Menu
                  visible={visible}
                  onDismiss={closeMenu}
                  style={styles.menu}
                  anchor={
                    <Appbar.Action icon="account-circle" size={35} color="white" onPress={openMenu} />
                  }>
                  <Menu.Item contentStyle={{justifyContent: 'center'}} titleStyle={{fontSize: 21}} title="Perfil" />
                  <Divider/>
          ...
          <View style={styles.area}>
            <Image source={require('../../assets/images/axolote_png.png')} style={styles.axolote}></Image>
            <Text style={styles.bemvindoText}>{usuario.genero === 'Feminino' ? 'Bem vinda!' : 'Bem vindo!'}</Text>
            <Text style={styles.bemvindoText}>Toda grande jornada começa com a primeira questão!</Text>
          </View>
          {/* <Pressable>
