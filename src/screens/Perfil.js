  ...
  return (
    <View style={styles.container}>
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        <Logo />
        <Pressable>
          <FontAwesome5 name="sign-out-alt" size={35} color="black" />
        </Pressable>
      </View>
      <View
        style={{
      ...
      >
        ...
        >
          ...
          <View>
            <Image
              source={require("../../assets/images/perfil_amarelo_bone.png")}
              style={styles.perfil}
            />
          ...
          <View style={styles.caminhotext}>
            ...
            <Text style={styles.texto}>
              Permita que o algoritmo selecione desafios para você.
            </Text>
          </View>
        </LinearGradient>
        <LinearGradient
